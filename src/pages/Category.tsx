              ...
              .map((category) => (
                <TableRow key={category._id}>
                  ...
                  <TableCell>
                    <Button
                      variant="outline"
                      className="text-white bg-[linear-gradient(to_right,#264D59,#041B2D)] !border-0"
                      size="sm"
                    ...
                    <Button
                      variant="destructive"
                      size="sm"
                      className="ml-2 bg-[linear-gradient(to_right,#041B2D,#264D59)] !border-0"
                ...
                <TableRow key={category._id}>
                  ...
                  <TableCell>
                    ...
                    <Button
                      variant="destructive"
                      size="sm"
                      className="ml-2 bg-[linear-gradient(to_right,#041B2D,#264D59)]"
                      onClick={() => handleDeleteCategory(category)}
                    >
                      Delete
                    </Button>
