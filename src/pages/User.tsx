...
const User: React.FC = () => {
  ...
  return (
    <div className="p-2 sm:p-4">
      <div
        className="text-xl sm:text-2xl text-center font-bold text-white mb-4 p-2 bg-white/20  rounded-lg
        ...
        <Table className="bg-white/90 p-2 sm:p-10 backdrop-blur-3xl">
          <TableHeader>
            <TableRow className="border-b border-gray-300/50">
              <TableHead className="py-3 px-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-700">
                Username
              </TableHead>
              <TableHead className="py-3 px-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-700">
                Email
          ...
          <TableBody>
            {users.map((user) => (
              <TableRow
                key={user._id}
                className="border-b border-gray-200/50 hover:bg-gray-50/10"
              >
                <TableCell className="py-2 px-2 sm:py-3 sm:px-4 whitespace-nowrap">
                  {user.username}
                </TableCell>
                <TableCell className="py-2 px-2 sm:py-3 sm:px-4 whitespace-nowrap">
                  {user.email}
